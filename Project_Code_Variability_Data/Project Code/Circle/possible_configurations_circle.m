function [current_config,configs_num,total_configs,total_trials,absolute_A,total_frequency,total_Q_matrix,total_energy_array] = possible_configurations_circle(source_loc,sinks,source_bound,radius,trials,target)
