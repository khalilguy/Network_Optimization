...
%     source_loc = [32 36 40]';
%     sinks = [1 7 11]';
%     generating_data_hu_cai(2,2,source_loc,sinks,source_bound,trials,target,tspan,c_0,weights,m(i),v(i));
%     analysis_hu_cai(2,2,source_loc,sinks,source_bound,trials,target,tspan,c_0,weights,m(i),v(i));
%     close all
% end 
